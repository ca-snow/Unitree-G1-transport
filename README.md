...
> 行走由 **PPO 强化学习** 策略驱动,抓取由 **脚本化专家 + 行为克隆(BC)** 策略完成,顶层由状态机编排并附带 **YOLO 视觉分类** 与视觉误差影子测量。
>本项目从示教采集到鲁棒化训练全程无使用任何外部采集设备，零遥操作。


演示视频：https://www.bilibili.com/video/BV1BYYt6FE8S/?spm_id_from=333.1387.upload.video_card.click&vd_source=cda1e9d85c270f0590fc6b0098f48607
